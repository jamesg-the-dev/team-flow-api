...
public sealed class TasksController : ControllerBase
{
    ...
    [ProducesResponseType(
        typeof(IReadOnlyDictionary<TaskColumn, IReadOnlyList<TaskBoardCardDto>>),
    ...
    public async Task<ActionResult> Move(
        ...
        (
            await _sender.Send(
                new MoveTaskCommand(id, body.TargetColumn, body.BeforeTaskId, body.AfterTaskId),
                ct
            )
        ).ToActionResult();
    ...
    public async Task<ActionResult<TaskCommentDto>> Comment(
        Guid id,
