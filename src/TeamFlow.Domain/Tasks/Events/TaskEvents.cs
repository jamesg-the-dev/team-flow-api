...
public sealed record TaskCreated(Guid TaskId, Guid ProjectId, int Number, Guid ReporterId) : DomainEvent;
public sealed record TaskColumnChanged(Guid TaskId, TaskColumn Column, DateTimeOffset At) : DomainEvent;
