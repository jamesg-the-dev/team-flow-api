...
internal sealed class GetTaskByIdHandler : IQueryHandler<GetTaskByIdQuery, TaskDto>
{
    ...
    public async Task<Result<TaskDto>> Handle(GetTaskByIdQuery request, CancellationToken ct)
    {
        ...
        if (t is null) return Error.NotFound($"Task '{request.Id}' not found.");

        return new TaskDto(t.Id, t.ProjectId, t.Number, t.Title, t.Description, t.Column, t.Priority,
            t.Position, t.AssigneeId, t.ReporterId, t.EstimateHours, t.DueDate, t.CompletedAt,
